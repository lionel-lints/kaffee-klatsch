...
Survey.create({"user_id"=>1, "coffees" => 1, "emotion" => 2.4, "weatherMain" => "rainy", "weatherDesc" => "light rain", "dayTempHi" => 50.4, "dayTempLow" => 39.2, "currentTemp" => 41.2, "created_at"=>"2015-12-25 07:00:00", "updated_at"=>"2015-12-25 07:00:00"})
Survey.create({"user_id"=>1, "coffees" => 2, "emotion" => 3.3, "weatherMain" => "rainy", "weatherDesc" => "light rain", "dayTempHi" => 50.4, "dayTempLow" => 39.2, "currentTemp" => 42.1, "created_at"=>"2015-12-26 09:00:00", "updated_at"=>"2015-12-26 09:00:00"})
Survey.create({"user_id"=>1, "coffees" => 2, "emotion" => 2.9, "weatherMain" => "rainy", "weatherDesc" => "light rain", "dayTempHi" => 50.4, "dayTempLow" => 39.2, "currentTemp" => 44.1, "created_at"=>"2015-12-27 11:00:00", "updated_at"=>"2015-12-27 11:00:00"})
Survey.create({"user_id"=>1, "coffees" => 3, "emotion" => 3.6, "weatherMain" => "rainy", "weatherDesc" => "light rain", "dayTempHi" => 50.4, "dayTempLow" => 39.2, "currentTemp" => 46.1, "created_at"=>"2015-12-27 13:00:00", "updated_at"=>"2015-12-27 13:00:00"})
Survey.create({"user_id"=>1, "coffees" => 4, "emotion" => 4.1, "weatherMain" => "rainy", "weatherDesc" => "light rain", "dayTempHi" => 50.4, "dayTempLow" => 39.2, "currentTemp" => 45.1, "created_at"=>"2015-12-28 15:00:00", "updated_at"=>"2015-12-28 15:00:00"})
Survey.create({"user_id"=>1, "coffees" => 4, "emotion" => 2.3, "weatherMain" => "rainy", "weatherDesc" => "light rain", "dayTempHi" => 50.4, "dayTempLow" => 39.2, "currentTemp" => 42.1, "created_at"=>"2015-12-28 19:00:00", "updated_at"=>"2015-12-28 19:00:00"})
